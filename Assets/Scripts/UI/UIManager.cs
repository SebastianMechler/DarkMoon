...
public class UIManager : MonoBehaviour
{
  ...
  public GameObject m_oxygenAndBatteryOne;
  ...
  public void SetBatteryUIState(bool state)
  {
    Debug.Log("disable battery-ui");
    m_oxygenAndBatteryOne.SetActive(state);
  }
  ...
  {
    if (SingletonManager.Tutorial.m_currentTutorialState != TutorialState.None)
    {
      return;
    }
